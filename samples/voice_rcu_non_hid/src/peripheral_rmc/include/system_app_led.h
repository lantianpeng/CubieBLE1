...
// add by pay
#define IR_TX_IND_BLINK_PERIOD		          250			/* 250 ms	*/
#define IR_TX_IND_TIMEOUT				            500			/* 500 ms	*/
#define IR_RX_IND_TIMEOUT					          250		  /* 250 ms	*/
#define IR_RX_IND_BLINK_PERIOD		          500		  /* 500 ms	*/
...
// add by zdx
void ir_switch_result_led_indication(u16_t state_time);
...
void btn_ble_led_indication(u8_t state); // zdx
void btn_ir_led_indication(u8_t state); // zdx
