...
#define REMOTE_KEY_VOICE_COMMAND				0x020d
#elif defined(USE_AL_ENCODE_2_8_1)
#define REMOTE_KEY_VOICE_COMMAND				0x020e
#elif defined(USE_AL_ENCODE_2_8_1_2)
#define REMOTE_KEY_VOICE_COMMAND				0x021e
#elif defined(USE_AL_ENCODE_3_4_1)
#define REMOTE_KEY_VOICE_COMMAND			0x020f
#elif defined(USE_AL_ENCODE_3_4_1_2)
#define REMOTE_KEY_VOICE_COMMAND 				0x0210
#else
