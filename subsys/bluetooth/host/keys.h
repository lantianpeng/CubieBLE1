...
void bt_update_keys_to_nv(struct bt_keys *keys);

struct bt_keys * bt_keys_find_from_nv(int type, const bt_addr_le_t *addr);

struct bt_keys *bt_keys_find_addr_from_nv(const bt_addr_le_t *addr);
