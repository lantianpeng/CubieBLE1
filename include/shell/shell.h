...
extern struct shell_module Image$$RW_IRAM_SHELL_CMD_START$$Base[];
extern struct shell_module Image$$RW_IRAM_SHELL_CMD_START$$Limit[];

extern struct shell_module *__shell_cmd_start;
extern struct shell_module *__shell_cmd_end;
extern int NUM_OF_SHELL_ENTITIES;

extern struct k_fifo *p_avail_queue;
extern struct k_fifo *p_cmds_queue;

extern int MAX_CMD_QUEUED;
extern struct console_input *shell_buf;

extern char *default_module_prompt;
extern const char *prompt;

void shell(void *p1, void *p2, void *p3);
u8_t completion(char *line, u8_t len);
void line_queue_init(void);
