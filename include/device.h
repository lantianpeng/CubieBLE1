...
extern struct device Image$$RW_IRAM_DEVICE_APPLICATION$$Limit[];

extern u32_t Image$$RW_IRAM_DEVICE_BUSY$$Base[];

extern u8_t *__device_busy_start;
extern u16_t DEVICE_BUSY_SIZE;
