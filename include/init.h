...
void register_kernel_cfg_func(void *Keil_kernel_cfg_func);

void app_main(void);
void _sys_device_do_config_level(int level);
struct device *device_get_binding(const char *name);
int kernel_config_init(void);
void _PrepC(void *keil_isr_table, void *keil_app_main,
				void *keil_sys_device_do_config_level,
				void *keil_device_get_binding, void *Keil_kernel_cfg_func);
