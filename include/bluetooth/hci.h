...
#define BT_HCI_ERR_REMOTE_USER_TERM_CONN        0x13    /*!< Remote user terminated connection */
#define BT_HCI_ERR_LOCAL_USER_TERM_CONN         0x16    /*!< Connection terminated by local host */
