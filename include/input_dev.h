...
/* copy form linux kernel: include/linux/input.h */
...
#define KEY_TAB			15
#define KEY_10		KEY_0
#define KEY_11		KEY_MINUS
#define KEY_12		KEY_EQUAL
#define KEY_13		KEY_BACKSPACE
#define KEY_14		KEY_TAB
#define KEY_Q			16
#define KEY_W			17
#define KEY_E			18
#define KEY_R			19
 ...
 *
 *  Enable input device. Must be the called before any calls that
 *  require communication with the input device.
 *
...
/** @brief register callback into input_dev driver
 *
 *  @param dev Pointer to the device structure for the driver instance.
 *  @param cb Callback to notify input information to caller
 *
 */
...
/** @brief unregister callback from input_dev driver
 *
 *  @param dev Pointer to the device structure for the driver instance.
 *  @param cb Callback to notify input information to caller
 *
